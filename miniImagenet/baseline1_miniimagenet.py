...
from components.utils_hessian import generate_conv_hessian, generate_fc_hessian
...
def lobs(config, path_net, args, alpha=0.1):
    device = torch.device('cuda')
    ...
    # Load data
    mini = mini_Imagenet_one_task(PATH_MINIIMAGENET, args.imgsz, 'train', target)
    db_hessian = DataLoader(mini, batch_size=2, shuffle=True, num_workers=8, pin_memory=True)
    db = DataLoader(mini, batch_size=24, shuffle=True, num_workers=8, pin_memory=True)
    mini_test = mini_Imagenet_one_task(PATH_MINIIMAGENET, args.imgsz, 'test', target)
    db_test = DataLoader(mini_test, batch_size=32, shuffle=False, num_workers=8, pin_memory=True)
    ...
    # Prune
    for step_prune in range(1):
        # Obtain hessians
        hessians = dict()
        for idx, (x, y) in enumerate(db_hessian):
            x, y = x.to(device), y.to(device)

            _ = net(x)
            for name, input in net.layers_input.items():
                if name.startswith('c'):
                    hessian = generate_conv_hessian(input, net.kernel_size, 1, device)  # torch.device('cpu'))
                elif name.startswith('f'):
                    hessian = generate_fc_hessian(input, device)  # torch.device('cpu'))

                if name in hessians.keys():
                    hessians[name] = (hessians[name] * idx + hessian) / (idx + 1)
                else:
        ...
        for name in net.layers_name:
            ...
            # obtain arg sort
            hessian_inv = get_inv(hessians[name])
            l1, l2 = wb.shape
            L = np.zeros([l1 * l2])
...
if __name__ == '__main__':
    ...
    # Train net
    # for i in range(5):
    #     train_net(args, config, i + 1)

    # L-obs
    # for path in [
    # '/local/home/david/Remote/VibNet_Pytorch/model/lobs/net1-ori_[7,10,11,15,29].pkl',
    # '/local/home/david/Remote/VibNet_Pytorch/model/lobs/net2-ori_[12,14,15,22,42].pkl',
    # '/local/home/david/Remote/VibNet_Pytorch/model/lobs/net3-ori_[25,34,39,45,47].pkl',
    # '/local/home/david/Remote/VibNet_Pytorch/model/lobs/net4-ori_[10,51,57,59,60].pkl',
    # '/local/home/david/Remote/VibNet_Pytorch/model/lobs/net5-ori_[12,16,22,32,36].pkl'

    # '/local/home/david/Remote/VibNet_Pytorch/model/lobs/net1/net-cr_0.11.pkl',
    #     '/local/home/david/Remote/VibNet_Pytorch/model/lobs/net2/net-cr_0.11.pkl',
    #     '/local/home/david/Remote/VibNet_Pytorch/model/lobs/net3/net-cr_0.11.pkl',
    #     '/local/home/david/Remote/VibNet_Pytorch/model/lobs/net4/net-cr_0.11.pkl',
    #     '/local/home/david/Remote/VibNet_Pytorch/model/lobs/net5/net-cr_0.11.pkl',
    # ]:
    #     lobs(config, path, args, alpha=0.05)

    # maml
    for path in [
        '/local/home/david/Remote/VibNet_Pytorch/model/lobs/miniImagenet_32/net1/net-cr_0.06.pkl',
        '/local/home/david/Remote/VibNet_Pytorch/model/lobs/miniImagenet_32/net1/net-cr_0.11.pkl',
        '/local/home/david/Remote/VibNet_Pytorch/model/lobs/miniImagenet_32/net1/net-cr_0.21.pkl',
        '/local/home/david/Remote/VibNet_Pytorch/model/lobs/miniImagenet_32/net1/net-cr_0.50.pkl',
        '/local/home/david/Remote/VibNet_Pytorch/model/lobs/miniImagenet_32/net1/net-cr_0.70.pkl',

        # '/local/home/david/Remote/VibNet_Pytorch/model/lobs/net2/net-cr_0.06.pkl',
        # '/local/home/david/Remote/VibNet_Pytorch/model/lobs/net2/net-cr_0.11.pkl',
        #  '/local/home/david/Remote/VibNet_Pytorch/model/lobs/net2/net-cr_0.21.pkl',
        #  '/local/home/david/Remote/VibNet_Pytorch/model/lobs/net2/net-cr_0.50.pkl',
        #  '/local/home/david/Remote/VibNet_Pytorch/model/lobs/net2/net-cr_0.70.pkl',

        # '/local/home/david/Remote/VibNet_Pytorch/model/lobs/net3/net-cr_0.06.pkl',
        #'/local/home/david/Remote/VibNet_Pytorch/model/lobs/net3/net-cr_0.11.pkl',
        #'/local/home/david/Remote/VibNet_Pytorch/model/lobs/net3/net-cr_0.21.pkl',
        #'/local/home/david/Remote/VibNet_Pytorch/model/lobs/net3/net-cr_0.50.pkl',
        #'/local/home/david/Remote/VibNet_Pytorch/model/lobs/net3/net-cr_0.70.pkl',

        #'/local/home/david/Remote/VibNet_Pytorch/model/lobs/net4/net-cr_0.06.pkl',
        #'/local/home/david/Remote/VibNet_Pytorch/model/lobs/net4/net-cr_0.11.pkl',
        #'/local/home/david/Remote/VibNet_Pytorch/model/lobs/net4/net-cr_0.21.pkl',
        #'/local/home/david/Remote/VibNet_Pytorch/model/lobs/net4/net-cr_0.50.pkl',
        #'/local/home/david/Remote/VibNet_Pytorch/model/lobs/net4/net-cr_0.70.pkl',

        # '/local/home/david/Remote/VibNet_Pytorch/model/lobs/net5/net-cr_0.06.pkl',
        # '/local/home/david/Remote/VibNet_Pytorch/model/lobs/net5/net-cr_0.11.pkl',
        # '/local/home/david/Remote/VibNet_Pytorch/model/lobs/net5/net-cr_0.21.pkl',
        # '/local/home/david/Remote/VibNet_Pytorch/model/lobs/net5/net-cr_0.50.pkl',
        # '/local/home/david/Remote/VibNet_Pytorch/model/lobs/net5/net-cr_0.70.pkl'
