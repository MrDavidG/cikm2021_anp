...
def maml_lobs(args, config, path_load=None):
    ...
    for idx_prune in range(6):  # (int(1. / args.cr_step) + 1):
        # calculate hessians
        hessians_inv = dict()
        ...
        torch.save(
            ...
            '/local/home/david/Remote/VibNet_Pytorch/model/maml_lobs/mini-imagenet_conv32/5-way_5-shot/net_cr-%.2f_acc-%.4f.pkl' % (
...
if __name__ == '__main__':
    ...
    # prune
    argparser.add_argument('--cr_step', type=bool, help='cr at each iteration', default=0.05)
    ...
    # acc = 0
    # while acc < 0.625:
    #     acc = train_maml(args, config)

    # 正式开始lobs+maml
    # maml_lobs(args, config,
    #           '/local/home/david/Remote/VibNet_Pytorch/model/maml_lobs/mini-Imagenet/5-way_1-shot/anp_hessian_not_fsl/net_cr-0.21_acc-0.4529.pkl')

    # eval_maml(args, config,
    #               '/local/home/david/Remote/VibNet_Pytorch/model/maml_lobs/mini-Imagenet/5-way_5-shot/net_cr-0.31_acc-0.5562.pkl')

    # 5-way 5-shot
    maml_lobs(args, config,
              # '/local/home/david/Remote/VibNet_Pytorch/model/maml_lobs/mini-Imagenet/5-way_5-shot/net_cr-1.pkl')
              '/local/home/david/Remote/VibNet_Pytorch/model/maml_lobs/mini-imagenet_conv32/5-way_5-shot/net_cr-0.41_acc-0.6133.pkl')
